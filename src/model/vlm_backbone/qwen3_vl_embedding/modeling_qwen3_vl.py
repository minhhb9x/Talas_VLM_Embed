...
class Qwen3VLModelOutputWithPast(ModelOutput):
    ...
    # Add batch image embeds to output
    batch_image_embeds: Optional[List[torch.FloatTensor]] = None
    visual_pos_masks: Optional[List[torch.BoolTensor]] = None
...
class Qwen3VLTextModel(Qwen3VLPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        list_hidden_states = [inputs_embeds]
        ...
        for layer_idx, decoder_layer in enumerate(self.layers):
            layer_outputs, attention_weights = decoder_layer(
                hidden_states,
                attention_mask=attention_mask,
                position_ids=text_position_ids,
                past_key_values=past_key_values,
        ...
        list_hidden_states.pop(-1)  # remove the last hidden states before norm, to save memory
        list_hidden_states.append(hidden_states) # add the last hidden states after norm

        return BaseModelOutputWithPast(
            last_hidden_state=hidden_states,
            past_key_values=past_key_values,
            hidden_states=list_hidden_states,
            attentions=attention_weights_list,
        )
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return Qwen3VLModelOutputWithPast(
            **outputs,
            ...
            visual_pos_masks=visual_pos_masks,
            batch_image_embeds=deepstack_visual_embeds,
        )
...
class Qwen3VLForConditionalGeneration(Qwen3VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        #     loss = self.loss_function(logits=None, labels=labels, vocab_size=self.config.text_config.vocab_size)
